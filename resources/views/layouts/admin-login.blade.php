...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('web_components/app-assets/css/pages/authentication.css') }}">
    <!-- END: Page CSS-->
...
<script src="{{ asset('web_components/app-assets/js/core/app.j')}}s"></script>
<!-- END: Theme JS-->

<!-- BEGIN: Page JS-->
<script src="{{ asset('web_components/app-assets/js/scripts/pages/auth-register.js')}}"></script>
<!-- END: Page JS-->
