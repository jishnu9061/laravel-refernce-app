...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('admin.testimonial.store')}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12">
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('posted_by')is-invalid @enderror" id="posted_by" name="posted_by" value="{{ old('posted_by') }}"  placeholder="Posted By"
                    ...
                    <div class="col-12">
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="message" class="form-control" rows="5" id="" required>{{ old('message') }}</textarea>
                                @error('message')
                                <span id="message-error" class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-10">
                                <a href="#" class="me-25">
                                    <img src="{{ ProfileHelper::getProfileImageFromFile() }}" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                                </a>
