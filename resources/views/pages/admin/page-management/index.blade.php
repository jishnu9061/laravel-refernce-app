    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        <h3 class="fw-bolder mb-75">{{PageHelper::getTotalPageCount()}}</h3>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        <h3 class="fw-bolder mb-75">{{PageHelper::getActivePageCount()}}</h3>
    ...
    <div class="card">
        <div class="card-body border-bottom">
            ...
            <div class="row">
                ...
                <div class="col-md-4 page_status">
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
 ...
 buttons: [
   ...
   responsive: {
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="FilterTransaction">Pages</label>').appendTo('.user_testimonial');
            var select = $(
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="FilterTransaction">Status</label>').appendTo('.page_status');
            var select = $(
              '<select id="FilterTransaction" class="form-select text-capitalize mb-md-0 mb-2xx"><option value="">--Select--</option></select>'
            )
              .appendTo('.page_status')
              .on('change', function () {
                var val = $.fn.dataTable.util.escapeRegex($(this).val());
                column.search(val ? '^' + val + '$' : '', true, false).draw();
              });
   ...
   axios.get('{{ route("admin.get-pages") }}')
...
function deleteRecord(recordId) {
    ...
    var url = '{{ route("admin.page.destroy", ":id") }}';
...
function visitPage(){
    window.location='{{route('admin.page.create')}}';
}
