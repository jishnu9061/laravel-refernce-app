        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column">
                                <img class="img-fluid rounded mt-3 mb-2" src="{{ asset('web_components/app-assets/images/avatars/1.png')}}" height="110" width="110" alt="User avatar" />
                        ...
                        <div class="info-container">
                            ...
                            <div class="d-flex justify-content-center pt-2">
                                <a href="{{route('admin.user.edit',$userDetails->id)}}" class="btn btn-primary me-1" >
                                    Edit
                                </a>
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-pills mb-2">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('admin.view-data',$userDetails->id)}}">
                            <i data-feather="user" class="font-medium-3 me-50"></i>
                            <span class="fw-bold">Account</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.view-notification',$userDetails->id)}}">
                                ...
                                <div class="timeline-event">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-50">
                                        <div class="avatar me-50">
                                            <img src="{{ asset('web_components/app-assets/images/portrait/small/avatar-s-7.jpg')}}" alt="Avatar" width="38" height="38" />
                                        </div>
                                        <div class="user-info">
                            ...
                            <li class="timeline-item">
                                ...
                                <div class="timeline-event">
                                    ...
                                    <div class="d-flex flex-row align-items-center mt-50">
                                        <img class="me-1" src="{{ asset('web_components/app-assets/images/icons/pdf.png')}}" alt="data.json" height="25" />
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" id="modalEditUserFirstName" name="modalEditUserFirstName" class="form-control" placeholder="John" value="{{$userDetails->first_name}}" data-msg="Please enter your first name" />
                        </div>
                        <div class="col-12 col-md-6">
