@extends('layouts.admin-dashboard',['title' => 'Notifications'])
@section('content')
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="info-container">
                            ...
                            <div class="d-flex justify-content-center pt-2">
                                <a href="{{route('admin.user.edit',$userDetails->id)}}" class="btn btn-primary me-1" >Edit</a>
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-pills mb-2">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.view-data',$userDetails->id)}}">
                            <i data-feather="user" class="font-medium-3 me-50"></i>
                            <span class="fw-bold">Account</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('admin.view-notification',$userDetails->id)}}">
